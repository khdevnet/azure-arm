...
Param(
    ...
    [string] $ResourceGroupName = 'AzureWebApp',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'templates/service-farm/azuredeploy.json',
    [string] $TemplateParametersFile = 'templates/service-farm/azuredeploy.parameters.json',
